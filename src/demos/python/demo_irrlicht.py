...
# meshes. If you need a finer control on which item really needs a visualization
# proxy in Irrlicht, just use application.AssetBind(myitem); on a per-item
# basis.

myapplication.AssetBindAll()

# ==IMPORTANT!== Use this function for 'converting' into Irrlicht meshes the
# assets that you added to the bodies into 3D shapes, they can be visualized by
# Irrlicht!
